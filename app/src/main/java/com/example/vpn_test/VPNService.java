...
public class VPNService extends VpnService implements Handler.Callback {
    ...
    public void onCreate() {
        ...
        mConfigureIntent = PendingIntent.getActivity(this, 0, new Intent(this, VPNService.class),
    ...
    private void connect() {
        ...
        final Set<String> packages =
                prefs.getStringSet(MainActivity.Prefs.PACKAGES, Collections.<String>emptySet());
    ...
    private void startConnection(final ToyVpnConnection connection) {
        ...
        connection.setOnEstablishListener(new ToyVpnConnection.OnEstablishListener() {
            ...
            public void onEstablish(ParcelFileDescriptor tunInterface) {
                ...
                VPNService.this.setConnection(new Connection(thread, tunInterface));
            }
        });
        thread.start();
    }
