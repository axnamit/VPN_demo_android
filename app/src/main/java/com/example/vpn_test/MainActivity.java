    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.connect).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!MainActivity.this.checkProxyConfigs(proxyHost.getText().toString(),
                ...
                if (!MainActivity.this.checkPackages(packageSet)) {
                    return;
                }
                int serverPortNum;
                try {
                ...
                if (intent != null) {
                    ...
                    MainActivity.this.onActivityResult(0, RESULT_OK, null);
                }
            }
        });
